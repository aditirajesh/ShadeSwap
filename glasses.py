...
video_capture = cv2.VideoCapture(0) #initialises the webcam for capturing the video
glasses = cv2.imread("sunglasses.png", -1)
detector = dlib.get_frontal_face_detector() #initialise the face detector
predictor = dlib.shape_predictor("shape_predictor_68_face_landmarks.dat") #initialises the shape predictor 
